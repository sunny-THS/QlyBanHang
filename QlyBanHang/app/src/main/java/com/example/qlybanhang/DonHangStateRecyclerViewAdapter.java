...
import com.example.qlybanhang.databinding.FragmentDonHangStateBinding;
...
public class DonHangStateRecyclerViewAdapter extends RecyclerView.Adapter<DonHangStateRecyclerViewAdapter.ViewHolder> {

    private final ArrayList<HoaDon> mValues;

    public DonHangStateRecyclerViewAdapter(ArrayList<HoaDon> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(FragmentDonHangStateBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentDonHangStateBinding binding) {
